                            ...
                            >
                                ...
                                <div className={styles.frameDownload}>
                                    ...
                                    <Form.InputNumber
                                        ...
                                        extraText="录像单文件大小限制，单位：Byte，超过此大小分段下载，如需使用大小分段请注释此字段。eg：4294967296（4GB）"
                                        field="file_size"
                                        placeholder=""
                                        suffix={"Byte"}
                                        style={{ width: "100%" }}
                                    ...
                                    <Form.InputNumber
                                        ...
                                        extraText="小于此大小的视频文件将会被过滤删除，单位：MB"
...
当delay不存在时，默认延迟时间为0秒，没有快速上传的需求推荐设置5分钟(300秒)或按需设置。若设置的延迟时间超过60秒，则会启用分段检测机制，每隔60秒进行一次开播状态的检测。"
                                ...
                                <div className={styles.frameUpload}>
                                    <div className={styles.frameInside}>
                                        <div className={styles.group}>
                                            ...
                                            {/* <img
                                                title="全局上传设置"
                                                src="https://lf6-static.semi.design/obj/semi-tos/template/8102d462-48af-4c05-9413-2b23f24703a1.png"
                                                className={styles.lineStory}
                                            /> */}
                                            <div
                                                className={styles.lineStory}
                                    ...
                                    >
                                        <Form.Select.Option value="bda2">
                                            bda2
                                        </Form.Select.Option>
                                        <Form.Select.Option value="kodo">
                                            kodo
                                        </Form.Select.Option>
                                        <Form.Select.Option value="ws">
                                            ws
                                        </Form.Select.Option>
                                        <Form.Select.Option value="qn">
                                            qn
                                        </Form.Select.Option>
                                    </Form.Select>
                                    <Form.InputNumber
 ...
 应该设置为比主播数量要多一点的数，如果开启uploading_record需要设置的更多。"
                                ...
                                <img
                                    title="space"
                                    src="https://lf26-static.semi.design/obj/semi-tos/template/df3b366c-5477-428a-8c07-f52e5211c1be.svg"
                                ...
                                <div className={styles.framePlatformConfig}>
                                    <div className={styles.frameInside}>
                                        <div className={styles.group}>
                                            ...
                                            <img
                                                title="各平台下载设置"
                                                src="https://lf3-static.semi.design/obj/semi-tos/template/26853bea-9a55-4c4d-939b-d0a7c8f72613.png"
                                                className={
                                                    styles.outlinedVersion
                                                }
                                            />
                                        </div>
                                        <p
...
"
                                            ...
                                            >
                                                ...
                                                <Select.Option value="hls_ts">
                                                    hls_ts（ts流）
                                                </Select.Option>
                                                <Select.Option value="hls_fmp4">
                                                    hls_fmp4（fmp4流）
                                                </Select.Option>
                                            </Form.Select>
                                            <Form.Input
                                            ...
                                            <Form.Input
                                                ...
                                                extraText={
                                                    <div className="semi-form-field-extra">
                                                        如需要录制抖音www.douyin.com/user/类型链接或被风控,请在此填入cookie。
                                                        <br />
                                                        需要__ac_nonce、__ac_signature、sessionid的值，请不要将所有cookie填入。
                                                    </div>
                                                }
