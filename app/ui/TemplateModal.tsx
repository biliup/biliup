...
const TemplateModal: React.FC<TemplateModalProps> = ({ children, entity , onOk}) => {
    ...
    const collapsed = (<div className="semi-form-field-extra">
        触发时机为上传完成后(不上传也会触发，默认会删除，若要保留文件请设置为 mv )，将按自定义顺序执行自定义操作，当postprocessor不存在时，默认执行删除文件操作，示例：
        <br/>
        <code>run = echo hello!</code> 执行任意命令，等同于在shell中运行,视频文件路径作为标准输入传入
        <br/>
        <code>mv = backup/</code> 移动文件到backup目录下
        <br/>
        <code>run = python3 path/to/mail.py</code> 执行一个 Python 脚本，可以用来发送邮件等。<a
        href="https://biliup.github.io/biliup/Guide.html#%E4%B8%8A%E4%BC%A0%E5%AE%8C%E6%88%90%E5%90%8E%E5%8F%91%E9%80%81%E9%82%AE%E4%BB%B6%E9%80%9A%E7%9F%A5"
        target="_blank">自动发信通知脚本示例</a>
        <br/>
        <code>run = sh ./run.sh</code> 执行一个shell脚本，用途多样，主要调用系统内的cli工具。<a
        href="https://gist.github.com/UVJkiNTQ/ae4282e8f9fe4e45b3144b57605b4178"
        target="_blank">自动上传网盘脚本示例</a>
        <br/>
